...
# try/except block for adding rice and beans cost to add_ons variable
try:
    vars.add_ons += rice_beans.rice_beans_function(user_ingredient_selection)
except ValueError:
    print("")
...
print("######### FILLINGS #########")
print("")
for item_number, filling_options in enumerate(list.fillings_list):  # Prints out the items as a numbered list
    print(item_number + 1, filling_options.replace("_", " ").capitalize())
print("")
print("############################")
